...
function AddFacultyModal({ open, handleClose, handleSubmit }) {
  ...
  // useEffect(() => {
  //   setState(pre => ({ ...pre, Faculty_group_id: FacultyGroupSelection }))
  // }, [FacultyGroupSelection])

  //reset selection after modal is closed
  // useEffect(() => {
  //   if (state.Faculty_group_id === 0) setFacultyGroupSelection(0)
  // }, [state.Faculty_group_id])
